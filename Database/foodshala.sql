...
--
-- Host: localhost
-- Generation Time: May 22, 2021 at 08:41 AM
...
CREATE TABLE `orders` (
  ...
  `restaurant_id` bigint(20) UNSIGNED NOT NULL,
  `status` enum('CANCELED','PENDING','COMPLETED') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `users` (
  ...
  `mobile` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `preferance` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `order_items`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `order_items_order_id_item_id_unique` (`order_id`,`item_id`),
...
ALTER TABLE `restaurants`
  ...
  ADD UNIQUE KEY `restaurants_mobile_unique` (`mobile`);
